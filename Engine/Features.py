...
def geminai(query):
    try:
        ...
        response = model.generate_context(query)
...
#     #     chatbot = Gemini.ChatBot(cookie_path="Engine\cookies.json")
...
# def chatBot(query):
#     async def _chat():
#         chatbot = await Chatbot.create(cookie_path="Engine/cookies.json")
#         response = await chatbot.ask(prompt=query.lower())
#         await chatbot.close()
